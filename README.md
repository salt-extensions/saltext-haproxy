...
The saltext-haproxy project team welcomes contributions from the community.
...
```bash
# Clone the repo
git clone --origin salt git@github.com:salt-extensions/saltext-haproxy.git

# Change to the repo dir
cd saltext-haproxy

# Create a new venv
python3 -m venv env --prompt saltext-haproxy
...
* Writing blog posts
* Posting on social media about how you used Salt + HAProxy to solve your
